...
attendance_tracker.add_employee("Pratksha Mane", { 
    "2024-09-01": ("10:00", "14:00"),  # 4 hours
    "2024-09-02": ("10:15", "14:15"),  # 4 hours
    "2024-09-03": ("10:30", "14:30")   # 4 hours, totaling 12 hours (reduced)
})
attendance_tracker.add_employee("Prerna Jaju", {
    "2024-09-01": ("08:45", "17:30"), 
    "2024-09-02": ("09:00", "17:00")
})
attendance_tracker.add_employee("Nancy George", {
    "2024-09-02": ("09:00", "18:00")
})
